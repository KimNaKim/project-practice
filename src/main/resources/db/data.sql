...
-- ==========================================================
INSERT INTO notice_tb (category, title, content, view_count, created_at) VALUES 
('GENERAL', '2026년 봄 시즌 정식 오픈 안내', '안녕하세요. 캠핑장이 3월부터 정식 오픈합니다. 많은 이용 바랍니다.', 0, NOW()),
('IMPORTANT', '성수기 요금 및 예약 제한 기간 안내', '7월 15일부터 8월 20일까지 성수기 요금이 적용되며 2박 이상 우선 예약됩니다.', 0, NOW()),
('SYSTEM', '캠핑장 내 매너타임 준수 안내', '밤 10시부터는 매너타임입니다. 타인을 위해 고성방가를 자제해주세요.', 0, NOW());
